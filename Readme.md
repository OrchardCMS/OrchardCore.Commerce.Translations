...
All the localization files used for [Orchard Core Commerce](https://github.com/OrchardCMS/OrchardCore.Commerce). As a package, it's available from two sources:
